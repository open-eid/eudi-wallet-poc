...
enum class CredentialType(val value: String) {
    ...
    AGE_VERIFICATION("eu.europa.ec.eudi.age_verification.1")
}
...
enum class DocType(val uri: String) {
    ...
    MDL("org.iso.18013.5.1.mDL"),
    AGE_VERIFICATION("eu.europa.ec.eudi.pseudonym.age_over_18.1")
}
...
enum class Namespace(val uri: String) {
    ...
    EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1("eu.europa.ec.eudi.pseudonym.age_over_18.1"),
    NONE("");
...
enum class CredentialAttribute(
    ...
    AGE_VERIFICATION_USER_PSEUDONYM(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "user_pseudonym", true),
    AGE_VERIFICATION_ISSUANCE_DATE(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "issuance_date", true),
    AGE_VERIFICATION_EXPIRY_DATE(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "expiry_date", true),
    AGE_VERIFICATION_ISSUING_JURISDICTION(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "issuing_jurisdiction", true),
    AGE_VERIFICATION_ISSUING_AUTHORITY(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "issuing_authority", true),
    AGE_VERIFICATION_ISSUING_COUNTRY(DocType.AGE_VERIFICATION, Namespace.EU_EUROPA_EC_EUDI_AGE_VERIFICATION_1, "issuing_country", true);
