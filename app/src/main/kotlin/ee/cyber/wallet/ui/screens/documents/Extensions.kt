...
fun CredentialAttribute.label(): String = when (this) {
    ...
    CredentialAttribute.AGE_VERIFICATION_USER_PSEUDONYM -> stringResource(R.string.attr_user_pseudonym)
    CredentialAttribute.AGE_VERIFICATION_AGE_OVER_18 -> stringResource(R.string.attr_age_over_18)
    CredentialAttribute.AGE_VERIFICATION_ISSUANCE_DATE -> stringResource(R.string.attr_issuance_date)
    CredentialAttribute.AGE_VERIFICATION_EXPIRY_DATE -> stringResource(R.string.attr_expiry_date)
    CredentialAttribute.AGE_VERIFICATION_ISSUING_AUTHORITY -> stringResource(R.string.attr_issuing_authority)
    CredentialAttribute.AGE_VERIFICATION_ISSUING_JURISDICTION -> stringResource(R.string.attr_issuing_jurisdiction)
    CredentialAttribute.AGE_VERIFICATION_ISSUING_COUNTRY -> stringResource(R.string.attr_issuing_country)
}
...
fun DocumentField.isExpiry() = when (name) {
    ...
    CredentialAttribute.ORG_ISO_18013_5_1_EXPIRY_DATE.fieldName,
    CredentialAttribute.AGE_VERIFICATION_EXPIRY_DATE.fieldName -> true
