...
fun DocumentTypeIcon(docType: DocType) {
    val color = if (docType == DocType.MDL) pink else colorsBlueBlue300
    Card(
        modifier = Modifier
            .width(40.dp)
            .height(32.dp),
        ...
        Box(
            ...
            Icon(
                ...
                imageVector = if (docType == DocType.MDL) Icons.Filled.DirectionsCarFilled else Icons.Filled.Person,
                contentDescription = "",
                tint = color
            )
        }
